...
<head>
  ...
  <title>Pages / Login - SISTEM INFORMASI DOKUMEN</title>
...
<body>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              {{-- <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">SISTEM INFORMASI DOKUMEN</span>
                </a>
              </div><!-- End Logo --> --}}
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    @if ($errors->any())
                    <div class="alert alert-danger alert-dismissible show mb-2" role="alert">
                        <span class="flex items-center">
                            <i class="iconify" data-icon="mdi:alert" class="w-6 h-6 mr-2"> </i>
        
                            Terjadi Kesalahan Dalam Melakukan Pendaftaran Akun
                  ...
                  <form action="{{ route('loginpost') }}" method="POST" class="row g-3 needs-validation" novalidate>
                    @csrf
                    <div class="col-12">
  ...
  <script src="{{ asset('assets/backend/assets/vendor/quill/quill.min.js') }}"></script>
