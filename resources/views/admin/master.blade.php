...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('assets/backend/assets/img/favicon.png') }}" rel="icon">
    <link href="{{ asset('assets/backend/assets/img/apple-touch-icon.png') }}" rel="apple-touch-icon">
...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('produk.admin') }}">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('voucher.admin') }}">
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>Test MSIB</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
